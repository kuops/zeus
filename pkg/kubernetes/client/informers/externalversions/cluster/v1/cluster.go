...
import (
	...
	versioned "zeus/pkg/kubernetes/client/clientset/versioned"
	internalinterfaces "zeus/pkg/kubernetes/client/informers/externalversions/internalinterfaces"
	v1 "zeus/pkg/kubernetes/client/listers/cluster/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ClusterV1().Clusters().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ClusterV1().Clusters().Watch(context.TODO(), options)
			},
		},
		&clusterv1.Cluster{},
		resyncPeriod,
