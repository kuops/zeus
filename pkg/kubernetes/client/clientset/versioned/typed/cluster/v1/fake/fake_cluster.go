...
var clustersResource = schema.GroupVersionResource{Group: "cluster.shiny.io", Version: "v1", Resource: "clusters"}

var clustersKind = schema.GroupVersionKind{Group: "cluster.shiny.io", Version: "v1", Kind: "Cluster"}
...
func (c *FakeClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *clusterv1.Cluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(clustersResource, name), &clusterv1.Cluster{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeClusters) List(ctx context.Context, opts v1.ListOptions) (result *clusterv1.ClusterList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(clustersResource, clustersKind, opts), &clusterv1.ClusterList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeClusters) Create(ctx context.Context, cluster *clusterv1.Cluster, opts v1.CreateOptions) (result *clusterv1.Cluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(clustersResource, cluster), &clusterv1.Cluster{})
	if obj == nil {
		return nil, err
	}
	return obj.(*clusterv1.Cluster), err
...
func (c *FakeClusters) Update(ctx context.Context, cluster *clusterv1.Cluster, opts v1.UpdateOptions) (result *clusterv1.Cluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(clustersResource, cluster), &clusterv1.Cluster{})
	if obj == nil {
		return nil, err
	}
	return obj.(*clusterv1.Cluster), err
...
func (c *FakeClusters) UpdateStatus(ctx context.Context, cluster *clusterv1.Cluster, opts v1.UpdateOptions) (*clusterv1.Cluster, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(clustersResource, "status", cluster), &clusterv1.Cluster{})
	if obj == nil {
		return nil, err
	}
	return obj.(*clusterv1.Cluster), err
...
func (c *FakeClusters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(clustersResource, name, opts), &clusterv1.Cluster{})
	return err
}
...
func (c *FakeClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *clusterv1.Cluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(clustersResource, name, pt, data, subresources...), &clusterv1.Cluster{})
	if obj == nil {
		return nil, err
	}
	return obj.(*clusterv1.Cluster), err
